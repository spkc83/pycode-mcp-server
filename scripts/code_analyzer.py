...
class CodeVisitor(ast.NodeVisitor):
    ...
    def _extract_docstring(
        self, node: Union[ast.FunctionDef, ast.AsyncFunctionDef, ast.ClassDef, ast.Module]
    ) -> Optional[str]:
...
def main() -> None:
    ...
    parser.add_argument(
        "--json", action="store_true", help="Force JSON output (default for structured)"
    )
